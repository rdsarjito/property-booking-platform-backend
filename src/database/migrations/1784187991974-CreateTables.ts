...
export class CreateTables1784187991974 implements MigrationInterface {
  name = 'CreateTables1784187991974';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "properties" ("id" SERIAL NOT NULL, "name" character varying(200) NOT NULL, "city" character varying(100) NOT NULL, "address" text NOT NULL, "type" "public"."properties_type_enum" NOT NULL, "rating" numeric(3,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
